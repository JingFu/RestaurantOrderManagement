...
//	   $form.after($("<span></span>").text("user name and password cannot be empty").attr({id: "errorMsg", class: "error"}));
	   $h1.after($("<span></span>").text("user name and password cannot be empty").attr({id: "errorMsg", class: "error"}));
	   return false;
   } 
   else if(password !== passwordConfirm) {
//	   $form.after($("<span></span>").text("Password and password confirm fields don't match").attr({id: "errorMsg", class: "error"}));
	   $h1.after($("<span></span>").text("Password and password confirm fields don't match").attr({id: "errorMsg", class: "error"}));
	   return false;
   }
   return true;
